...
<div class="container">
    <h5><a href="<?php echo PATH3;?>article">< 返回</a></h5>

    <h4 class="text-center text-primary">编辑文档</h4>
    <h5 class="text-danger text-center">
        <?php echo $title;?>
    </h5>
    <form method="post" action="<?php echo PATH3;?>edit">
        ...
        <b style="color: #ff6d72">设置为推荐文章  </b><input type="checkbox" name="bid" value="1">
